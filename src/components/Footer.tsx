...
export default function Footer() {
  return (
    <div className='footer h-32 bg-gray-800'>
      <div className='footer-container h-full w-[1024px] flex  mx-auto items-center justify-between'>
        ...
        <div className='footer-socials flex gap-4'>
          <a className='bg-white' href="https://github.com/jlamar27" target="_blank" rel="noopener noreferrer">
            <GithubSVG />
          </a>
